...
if fig_kin_8bar
    ...
    subplot(311)
    plot(t,ddphi2)
    ylabel('dd\phi2 [rad/s^2]')
    subplot(312)
    plot(t,ddphi4)
    ylabel('dd\phi4 [rad/s^2]')
    subplot(313)
    plot(t,ddx8)
    ylabel('ddx8 [m/s^2]')
    xlabel("time [s]")
    ...
    subplot(411)
    plot(t,Controlp1)
    ylabel('Position error E')
    xlabel("time [s]")
    title('Position errors')
    subplot(412)
    plot(t,Controlp2)
    ylabel('Position error B')
    xlabel("time [s]")
    subplot(413)
    plot(t,Controlp3)
    ylabel('Position error F')
    xlabel("time [s]")
    subplot(414)
    plot(t,Controlp4)
    ylabel('Position error C')
    xlabel("time [s]")
...
% % Do the same for speed
    ...
    subplot(411)
    plot(t,Controlv1)
    ylabel('Speed error E')
    xlabel("time [s]")
    title("Speed errors")
    subplot(412)
    plot(t,Controlv2)
    ylabel('Speed error B')
    xlabel("time [s]")
    subplot(413)
    plot(t,Controlv3)
    ylabel('Speed error F')
    xlabel("time [s]")
    subplot(414)
    plot(t,Controlv4)
    ylabel('Speed error C')
    xlabel("time [s]")
...
% % Do the same for acceleration
    ...
    subplot(411)
    plot(t,Controla1)
    ylabel('Acceleration error E')
    xlabel("time [s]")
    title("Acceleration errors")
    subplot(412)
    plot(t,Controla2)
    ylabel('Acceleration error B')
    xlabel("time [s]")
    subplot(413)
    plot(t,Controla3)
    ylabel('Acceleration error F')
    xlabel("time [s]")
    subplot(414)
    plot(t,Controla4)
    ylabel('Acceleration error C')
    xlabel("time [s]")
    ...
    ylabel('Accelerationx8')
    xlabel("time [s]")
    subplot(616)
    plot(t,control_numeric_ddy8)
    ylabel('Accelerationy8')
    xlabel("time [s]")
